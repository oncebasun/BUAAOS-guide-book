...
%\setCJKmainfont[BoldFont={WenQuanYi Micro Hei},ItalicFont={AdobeKaitiStd-Regular}]{AdobeSongStd-Light}
%\setCJKsansfont[BoldFont={WenQuanYi Micro Hei}]{AdobeKaitiStd-Regular}
...
\input{chapters/2-memory}
\input{chapters/3-process}
\input{chapters/4-syscall}
\input{chapters/5-file-system}
\input{chapters/6-shell}
\begin{appendix}
\input{chapters/0-environment}
\end{appendix}
\end{document}
